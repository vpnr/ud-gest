...
insert into entreprise (libelle_entreprise, numero_rue, libelle_rue, cp_entreprise, ville_entreprise, tel_entreprise, fax_entreprise, mail_entreprise, siteweb_entreprise) values ("Norauto", "22", "avenue aristid briand", "91254", "bagneux", "0145401010", "0145478585", "a2rt@msn.com", "www.A2RT-bagneux.com");
...
insert into entreprise (libelle_entreprise, numero_rue, libelle_rue, cp_entreprise, ville_entreprise, tel_entreprise, fax_entreprise, mail_entreprise, siteweb_entreprise) values ("Mcdo", "5", "avenue galile", "06125", "nice", "0150454210", "0150421050", "ocp@gmail.com", "www.ocp.com");
insert into entreprise (libelle_entreprise, numero_rue, libelle_rue, cp_entreprise, ville_entreprise, tel_entreprise, fax_entreprise, mail_entreprise, siteweb_entreprise) values ("Quick", "3", "rue danton", "36654", "toulon", "0112455201", "0145523550", "afcepf@afcepf.fr", "www.Afcepf-formation.fr");

insert into event (title_event, description_event, start, end, id_event_entreprise) values ("Election OCP", "Election description", "2018-02-26", "2018-02-27", 1);
insert into event (title_event, description_event, start, end, id_event_entreprise) values ("Election AFCEPF", "Election description", "2018-03-01", "2018-03-02", 2);
insert into event (title_event, description_event, start, end, id_event_entreprise) values ("Election A2RT", "Election description", "2018-02-12", "2018-02-13", 3);
insert into event (title_event, description_event, start, end, id_event_entreprise) values ("Election Cerp", "Election description", "2018-02-14", "2018-02-15", 4);
insert into event (title_event, description_event, start, end, id_event_entreprise) values ("Election EQL", "Election description", "2018-02-10", "2018-02-11", 5);
insert into event (title_event, description_event, start, end, id_event_entreprise) values ("Election Norauto", "Election description", "2018-02-02", "2018-02-03", 6);
insert into event (title_event, description_event, start, end, id_event_entreprise) values ("Election Ausy", "Election description", "2018-02-06", "2018-02-07", 7);
insert into event (title_event, description_event, start, end, id_event_entreprise) values ("Election Mcdo", "Election description", "2018-02-15", "2018-02-16", 8);
insert into event (title_event, description_event, start, end, id_event_entreprise) values ("Election Quick", "Election description", "2018-02-19", "2018-02-20", 9);

insert into syndicat (libelle_syndicat, numero_rue, libelle_rue, cp_syndicat, ville_syndicat, tel_syndicat, fax_syndicat, mail_syndicat, siteweb_syndicat, id_federation_syndicat, id_ud_syndicat) values ("FO78",  "78", "rue du moulin", "12458", "nantes", "0145859696", "0112131313", "fo@gmail.com", "www.fo78.fr", 2, 1);
insert into syndicat (libelle_syndicat, numero_rue, libelle_rue, cp_syndicat, ville_syndicat, tel_syndicat, fax_syndicat, mail_syndicat, siteweb_syndicat, id_federation_syndicat, id_ud_syndicat) values ("CGT92",  "10", "rue marcel samba", "25441", "saindié", "0145487854", "0146305050", "cgt@yahoo.fr", "www.cgt92.org", 2, 2);
insert into syndicat (libelle_syndicat, numero_rue, libelle_rue, cp_syndicat, ville_syndicat, tel_syndicat, fax_syndicat, mail_syndicat, siteweb_syndicat, id_federation_syndicat, id_ud_syndicat) values ("CGT78",  "7", "villa lamarre", "10212", "beaulieu", "0132151749", "0124545201", "lagoute@hotmail.fr", "www.cgt78.fr", 1, 2);
insert into syndicat (libelle_syndicat, numero_rue, libelle_rue, cp_syndicat, ville_syndicat, tel_syndicat, fax_syndicat, mail_syndicat, siteweb_syndicat, id_federation_syndicat, id_ud_syndicat) values ("FO92",  "9", "rue du moulin", "20001", "bastia", "0645487852", "0145784852", "fo@gmail.com", "www.fo92.com", 1, 3);
